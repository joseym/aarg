...
- When a bullet is shown with a bracketed measured result (e.g. "[measured result to fold in: 3x faster]"), you MUST include that exact figure in the rewritten bullet. It is the candidate's own verified number and a primary selling point — do not omit it, soften it into a qualitative phrase, or paraphrase it away. A quantified line beats an unquantified one every time.
